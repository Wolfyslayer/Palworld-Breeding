...
# Ensure you run this in your repo root
echo "📂 Updating website with Breeding Calculator..."

# Make sure src folder exists
mkdir -p src

# -----------------------------
# 1️⃣ Create BreedingCalculator.jsx
# -----------------------------
...
echo "✅ BreedingCalculator.jsx created in src/"

# -----------------------------
# 2️⃣ Instructions for App.jsx
# -----------------------------
echo "📝 To use it, open your src/App.jsx and add:"
echo "import BreedingCalculator from './BreedingCalculator';"
echo "Then replace your App component with: <BreedingCalculator />"

echo "🎉 Website updated to use all pals and passives!"
